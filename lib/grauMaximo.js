...
var calcularSenior = exports.calcularSenior = function calcularSenior(desenvolvimento, pcModalidade) {
  var values = [desenvolvimento.PROGRESSAO_SENIOR, insigniaEspecialSenior(desenvolvimento), (0, _requisito.percentualCordao)(_requisitos2.default.dourado, desenvolvimento.especialidade), pcModalidade];
...
var calcularEscoteiro = exports.calcularEscoteiro = function calcularEscoteiro(desenvolvimento, pcModalidade) {
  var requisitoEspecialidades = { nivelMinimo: 1, quantidadeMinima: 5 };
  var values = [desenvolvimento.PROGRESSAO_PISTA_TRILHA, desenvolvimento.PROGRESSAO_RUMO_TRAVESSIA, insigniaEspecialEscoteiro(desenvolvimento), (0, _requisito.percentualCordao)(_requisitos2.default.vermelhoBranco, desenvolvimento.especialidade), pcModalidade];
