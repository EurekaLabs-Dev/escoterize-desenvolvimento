...
var calcularSenior = exports.calcularSenior = function calcularSenior(desenvolvimento, pcModalidade) {
  var values = [desenvolvimento.PROGRESSAO_SENIOR || 0, insigniaEspecialSenior(desenvolvimento), (0, _requisito.percentualCordao)(_requisitos2.default.dourado, desenvolvimento.especialidade), pcModalidade];
...
var calcularLobinho = exports.calcularLobinho = function calcularLobinho(desenvolvimento) {
  ...
  var values = [desenvolvimento.PROGRESSAO_PATATENRA_SALTADOR || 0, desenvolvimento.PROGRESSAO_RASTREADOR_CACADOR || 0, insigniaEspecialLobinho(desenvolvimento), (0, _requisito.percentualRamos)(requisitoEspecialidades, desenvolvimento.especialidade), (0, _requisito.calcularPercentualDistribuicao)(desenvolvimento.especialidade, 3)];
...
var calcularEscoteiro = exports.calcularEscoteiro = function calcularEscoteiro(desenvolvimento, pcModalidade) {
  var requisitoEspecialidades = { nivelMinimo: 1, quantidadeMinima: 5 };
  var values = [desenvolvimento.PROGRESSAO_PISTA_TRILHA || 0, desenvolvimento.PROGRESSAO_RUMO_TRAVESSIA || 0, insigniaEspecialEscoteiro(desenvolvimento), (0, _requisito.percentualCordao)(_requisitos2.default.vermelhoBranco, desenvolvimento.especialidade), pcModalidade];
