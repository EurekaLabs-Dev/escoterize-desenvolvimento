...
var percentualServicos = function percentualServicos(_ref, _ref2) {
  var nivelMinimo = _ref.nivelMinimo;
  var _ref2$SERVICOS = _ref2.SERVICOS,
      _ref2$SERVICOS$n = _ref2$SERVICOS.n2,
      n2 = _ref2$SERVICOS$n === undefined ? 0 : _ref2$SERVICOS$n,
      _ref2$SERVICOS$n2 = _ref2$SERVICOS.n3,
      n3 = _ref2$SERVICOS$n2 === undefined ? 0 : _ref2$SERVICOS$n2;
...
var percentualCordao = exports.percentualCordao = function percentualCordao(requisito, desenvolvimento) {
  ...
  var percentuais = [percentualRamos(_ramda2.default.merge(requisito, { nivelMinimo: 1 }), desenvolvimento), calcularPercentualDistribuicao(requisito, desenvolvimento), percentualServicos(requisito, desenvolvimento), percentuaisEspecialidadesEspecificas(_ramda2.default.merge(requisito, { quantidadeMinima: 1 }), desenvolvimento)];
