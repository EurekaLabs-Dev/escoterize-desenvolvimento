...
var calcularPercentualDistribuicao = exports.calcularPercentualDistribuicao = function calcularPercentualDistribuicao(desenvolvimento, quantidadeRamos) {
  return _ramda2.default.compose(_utils.limites1, _utils.roundTo2, function (x) {
...
var percentualCordao = exports.percentualCordao = function percentualCordao(requisito, desenvolvimento) {
  ...
  var pesos = [0.9 * requisito.quantidadeMinima, 0.1 * requisito.quantidadeMinima];
